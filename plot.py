...
bbox_props = dict(boxstyle="round,pad=0.3", ec="gray", lw=0.5, facecolor="gray", alpha=0.15)
bbox_small = dict(boxstyle="round,pad=0.3", ec="gray", lw=0.5, facecolor="gray", alpha=0.15)
...
for la in dele:
    x = la[0]
    y = la[1]
    ax.annotate("",  xy=(x-0.4, y-0.15), xycoords='data', xytext=(x+0.4, y+0.15), textcoords='data', arrowprops=dict(arrowstyle="-"))
    ax.annotate("",  xy=(x+0.4, y-0.15), xycoords='data', xytext=(x-0.4, y+0.15), textcoords='data', arrowprops=dict(arrowstyle="-"))
for la in ins:
    x = la[0]
    y = la[1]
    ax.annotate("",  xy=(x-0.4, y+0.4), xycoords='data', xytext=(x, y+0.2), textcoords='data', arrowprops=dict(arrowstyle="-"))
    ax.annotate("",  xy=(x+0.4, y+0.4), xycoords='data', xytext=(x, y+0.2), textcoords='data', arrowprops=dict(arrowstyle="-"))
    ax.text(la[0] -0.2, la[1] + 0.4, la[2], fontsize=6, bbox=bbox_props, ha='center')
